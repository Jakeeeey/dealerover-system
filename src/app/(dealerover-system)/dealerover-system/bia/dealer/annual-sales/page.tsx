...
import { AnnualSalesPage } from "@/modules/dealerover-system/bia/dealer/annual-sales";
import { AnnualSalesFilterProvider } from "@/modules/dealerover-system/bia/dealer/annual-sales/providers/AnnualSalesFilterProvider";
                    ...
                    <div className="min-w-0 overflow-hidden">
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                ...
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#">Dealer</BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block shrink-0" />
