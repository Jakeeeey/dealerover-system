...
} from "../utils/annual-sales.utils";
import type { DashboardSummary } from "../types/annual-sales.schema";

interface AnnualSalesKPICardsProps {
...
export function AnnualSalesKPICards({
  summary,
  isLoading,
}: AnnualSalesKPICardsProps) {
  if (isLoading) {
    return (
